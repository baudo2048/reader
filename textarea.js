...
tCode.style.resize='none'
tCode.style.flexGrow='1'
tCode.style.fontFamily='Consolas, "Courier New", monospace'
tCode.style.fontSize='14px'
tCode.style.backgroundColor='black'
tCode.style.color='white'
tCode.contentEditable= 'true'

root.appendChild(tCode)
